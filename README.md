...
<h1>
  <img src="https://raw.githubusercontent.com/YunoHost/apps/main/logos/torrelay.png" width="32px" alt="Logo of Tor relay">
  Tor relay, packaged for YunoHost
</h1>
...
[![Version: 0.4.8.17~ynh1](https://img.shields.io/badge/Version-0.4.8.17~ynh1-rgb(18,138,11)?style=for-the-badge)](https://ci-apps.yunohost.org/ci/apps/torrelay/)
...
<a href="https://github.com/YunoHost-Apps/torrelay_ynh/issues"><img height="100px" src="https://github.com/YunoHost/yunohost-artwork/raw/refs/heads/main/badges/neopossum-badges/badge_report_an_issue.svg"/></a>
</div>
...
```
# fresh install:
sudo yunohost app install https://github.com/YunoHost-Apps/torrelay_ynh/tree/testing

# upgrade an existing install:
sudo yunohost app upgrade torrelay -u https://github.com/YunoHost-Apps/torrelay_ynh/tree/testing
```
